...
- [x] Add typed ECR, ECS, EKS, RDS, database, VPC, Route 53, and Cost Explorer manager forms,
      paginated inventory, previews, waiters, bulk partial results, and status events. Full
      packaged runtime and provider verification remains pending for the ultra-speed lane.
