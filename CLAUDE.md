...
because the workflow has no push trigger; it remains manually dispatchable from `main`. This
updater change does not dispatch it, and no `0.4.0` release is claimed until the final packaged
install/update interactions are complete.
