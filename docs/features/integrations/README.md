...
| [AWS core-service managers](aws-core-services.md) | guided S3, EC2, IAM, STS, Lambda, CloudWatch, and Logs operations with local bindings and portable intent; source-only until integration verification |
