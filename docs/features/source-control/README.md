...
A VS Code-style git panel on the canvas, plus one-step git worktrees bound to canvas group
...
- [Source control & worktrees](./source-control-and-worktrees.md) — stage/unstage, diff,
  branch, commit, push; worktree creation, nested-repository discovery, scoping, reconciliation,
  and safe removal.
