...
- [Annotation labels and line thickness](./annotation-labels.md) — colored frames, lines, arrows,
  editable labels, bounded stroke widths, portable projection, and keyboard-accessible controls.
