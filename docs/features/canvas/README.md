...
- [Read-only Windows diagnostics](./windows-diagnostics.md) — bounded local drives, storage,
  services, startup, scheduled tasks, updates, network state, and event summaries.
