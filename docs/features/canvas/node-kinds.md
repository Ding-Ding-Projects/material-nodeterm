...
| **Shop** | A fixed catalog anchor owned by a Multiverse or AWS Universe child canvas. It is not movable, groupable, duplicable, or deletable, and its entries stay scoped to that child canvas. |
