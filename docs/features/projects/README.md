...
- [Portal-door entry](./portal-door-entry.md): optional numeric code or passphrase admission,
  vault-backed local verification, bounded waits, durations, relock, and portable presence-only
  metadata.
