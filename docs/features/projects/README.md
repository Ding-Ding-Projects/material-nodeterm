...
- [Door-only portal navigation](./portal-navigation.md): matched entry and return doors for
  special child canvases, scoped search, focus restoration, and relaunch-at-root behavior.
