...
- [Portal lifecycle and child-content recovery](./portal-lifecycle.md): immutable door pairs,
  deterministic Shops, import repair, orphan recovery, deletion preservation, and idempotent
  history and peer events.
