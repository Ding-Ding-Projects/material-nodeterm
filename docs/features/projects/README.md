...
- [Provider accounts](./provider-accounts.md): named local profiles, sealed operating-system
  credential references, OAuth callback lifecycle, and project/node-local bindings kept separate
  from portable blueprints.
