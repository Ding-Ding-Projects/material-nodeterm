...
describe('run-headless-gallery CLI boundaries', () => {
  ...
  it('rejects unsafe endpoints, tool errors, and a launch schema without an isolated environment field', async () => {
    ...
    try {
      ...
      await client.initialize()
      expect(() => client.launchEnvironmentArgument({ APPDATA: 'C:\\isolated' })).toThrow(/no supported environment field/)
