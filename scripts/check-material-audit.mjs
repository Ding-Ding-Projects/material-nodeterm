...
const SURFACES = [
  ...
  ...rows('settings', [
    ...
    ['settings-agent-hud', 'Agent HUD settings', 'src/renderer/components/settings/sections/AgentHudSection.tsx', 'export function AgentHudSection', 'md3-settings-card'],
