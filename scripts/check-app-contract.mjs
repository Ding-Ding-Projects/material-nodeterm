...
const FEATURES = [
  ...
  },
  {
    ...
    contentChecks: [
      ['src/core/windows-diagnostics.ts', 'export class WindowsDiagnosticsService'],
      ['src/shared/windows-diagnostics.ts', 'export const WINDOWS_DIAGNOSTIC_KINDS ='],
      ['src/renderer/nodes/WindowsDiagnosticsNode.tsx', 'export default function WindowsDiagnosticsNode('],
      ['src/renderer/canvas/Canvas.tsx', "label: 'New Windows diagnostics'"],
      ['src/main/index.ts', 'IPC.windowsDiagnosticsSnapshot'],
      ['src/shared/i18n/catalog.ts', "'windowsDiagnostics.title'"],
    ],
