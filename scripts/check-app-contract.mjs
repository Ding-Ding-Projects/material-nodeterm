...
const FEATURES = [
  ...
  },
  {
    ...
    contentChecks: [
      ...
      ['src/core/virtual-machine/manager.ts', 'async remove('],
      ['src/core/virtual-machine/manager.ts', 'qemuDiskBlockdevArgs('],
      ['src/core/virtual-machine/manager.ts', 'hasIso9660Signature('],
      ['src/core/virtual-machine/manager.ts', 'assertFileUnchanged('],
    ...
    tests: [
      ['src/core/virtual-machine/manager.test.ts', "describe('VirtualMachineManager'"],
      ['src/core/virtual-machine/manager.test.ts', 'requires an explicit raw selection'],
      ['src/core/virtual-machine/manager.test.ts', 'rejects relative and control-character asset paths']
    ],
