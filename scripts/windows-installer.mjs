...
// Vitest/Vite cannot execute resedit's createRequire-based ESM shim when dependencies are
// inlined. Loading its CommonJS entry through Node keeps tests and the production CLI on the
// same implementation.
