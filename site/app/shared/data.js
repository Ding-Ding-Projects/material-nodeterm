...
export const FEATURES = [
  ...
  { id: 'gitlab', icon: '🦊', color: 'var(--orange)', title: 'GitLab Server hosting', body: 'Guided CE or EE hosting with pinned official images, four persistent volumes, readiness, backup, restore, update, rollback and private-first binding.' },
...
export const COVERAGE = [
  ...
  ['GitLab Server CE and EE hosting with four managed volumes', 'GitLab Server node', 'partial'],
