...
export const FEATURES = [
  ...
  { id: 'cloudflare', icon: '☁️', color: 'var(--blue)', title: 'Cloudflare tunnel manager', body: 'Inspect tunnel state, preserve routes, prove DNS ownership and keep bindings on the computer that owns them.' },
...
export const COVERAGE = [
  ...
  ['Cloudflare tunnel inventory with route preservation and DNS ownership proof', 'Cloudflare room', 'done'],
