...
export function registerAboutYou(store, deps, registerAction, registerBinding) {
  registerBinding('about-nick', (s, id, value, h) => h.save({ nick: value.slice(0, 40) }, 'Nickname changed'))
  ...
  registerSettingsCard('you', {
    ...
    controls: (s) => [
      { label: 'Nickname', isText: true, commitOnChange: true, action: 'about-nick', value: s.nick, placeholder: 'e.g. Captain Socks' },
