...
const api: NodeTerminalApi = {
  ...
  kidsMode: {
    ...
    credentialState: () => ipcRenderer.invoke(IPC.kidsModeCredentialState),
    ...
    resetCredential: () => ipcRenderer.invoke(IPC.kidsModeResetCredential),
  ...
  dockerHost: {
    ...
    listContainers: (id) => ipcRenderer.invoke(IPC.dockerHostContainers, id),
    listImages: (id) => ipcRenderer.invoke(IPC.dockerHostImages, id),
    listVolumes: (id) => ipcRenderer.invoke(IPC.dockerHostVolumes, id),
    listNetworks: (id) => ipcRenderer.invoke(IPC.dockerHostNetworks, id),
    listCompose: (id, profile) => ipcRenderer.invoke(IPC.dockerHostComposeList, id, profile),
    startContainer: (id, containerId) => ipcRenderer.invoke(IPC.dockerHostContainerStart, id, containerId),
    stopContainer: (id, containerId, timeout) => ipcRenderer.invoke(IPC.dockerHostContainerStop, id, containerId, timeout),
    restartContainer: (id, containerId, timeout) => ipcRenderer.invoke(IPC.dockerHostContainerRestart, id, containerId, timeout),
    pauseContainer: (id, containerId) => ipcRenderer.invoke(IPC.dockerHostContainerPause, id, containerId),
    unpauseContainer: (id, containerId) => ipcRenderer.invoke(IPC.dockerHostContainerUnpause, id, containerId),
    stats: (id, containerIds) => ipcRenderer.invoke(IPC.dockerHostStats, id, containerIds),
    logs: (id, options) => ipcRenderer.invoke(IPC.dockerHostLogs, id, options),
    exec: (id, request) => ipcRenderer.invoke(IPC.dockerHostExec, id, request),
    previewDestructive: (input) => ipcRenderer.invoke(IPC.dockerHostPreviewDestructive, input),
    removeContainers: (id, ids, confirmed) => ipcRenderer.invoke(IPC.dockerHostRemoveContainers, id, ids, confirmed),
    removeImages: (id, ids, confirmed) => ipcRenderer.invoke(IPC.dockerHostRemoveImages, id, ids, confirmed),
    removeVolumes: (id, ids, confirmed) => ipcRenderer.invoke(IPC.dockerHostRemoveVolumes, id, ids, confirmed),
    removeNetworks: (id, ids, confirmed) => ipcRenderer.invoke(IPC.dockerHostRemoveNetworks, id, ids, confirmed),
    composeUp: (id, profile, services) => ipcRenderer.invoke(IPC.dockerHostComposeUp, id, profile, services),
    composeDown: (id, profile, confirmed) => ipcRenderer.invoke(IPC.dockerHostComposeDown, id, profile, confirmed)
  },
  relayClient: {
  ...
  unigetui: {
    status: () => ipcRenderer.invoke(IPC.unigetuiStatus),
    universeState: () => ipcRenderer.invoke(IPC.unigetuiUniverseState),
    saveUniverseState: (state) => ipcRenderer.invoke(IPC.unigetuiSaveUniverseState, state),
    appStatus: () => ipcRenderer.invoke(IPC.unigetuiAppStatus),
    navigate: (page) => ipcRenderer.invoke(IPC.unigetuiNavigate, page),
    operations: () => ipcRenderer.invoke(IPC.unigetuiOperations),
    operation: (id) => ipcRenderer.invoke(IPC.unigetuiOperation, id),
    operationOutput: (id, tail) => ipcRenderer.invoke(IPC.unigetuiOperationOutput, id, tail),
    operationWait: (id, timeout) => ipcRenderer.invoke(IPC.unigetuiOperationWait, id, timeout),
    operationCancel: (id) => ipcRenderer.invoke(IPC.unigetuiOperationCancel, id),
    operationRetry: (id, mode) => ipcRenderer.invoke(IPC.unigetuiOperationRetry, id, mode),
    operationReorder: (id, action) => ipcRenderer.invoke(IPC.unigetuiOperationReorder, id, action),
    operationForget: (id) => ipcRenderer.invoke(IPC.unigetuiOperationForget, id),
    managers: () => ipcRenderer.invoke(IPC.unigetuiManagers),
    managerAction: (manager, action, input) => ipcRenderer.invoke(IPC.unigetuiManagerAction, manager, action, input),
    sources: (manager) => ipcRenderer.invoke(IPC.unigetuiSources, manager),
    sourceAdd: (manager, name, url) => ipcRenderer.invoke(IPC.unigetuiSourceAdd, manager, name, url),
    sourceRemove: (manager, name, url) => ipcRenderer.invoke(IPC.unigetuiSourceRemove, manager, name, url),
    settings: () => ipcRenderer.invoke(IPC.unigetuiSettings),
    settingGet: (key) => ipcRenderer.invoke(IPC.unigetuiSettingGet, key),
    settingSet: (key, input) => ipcRenderer.invoke(IPC.unigetuiSettingSet, key, input),
    settingClear: (key) => ipcRenderer.invoke(IPC.unigetuiSettingClear, key),
    settingsReset: () => ipcRenderer.invoke(IPC.unigetuiSettingsReset),
    shortcuts: () => ipcRenderer.invoke(IPC.unigetuiShortcuts),
    shortcutSet: (path, status) => ipcRenderer.invoke(IPC.unigetuiShortcutSet, path, status),
    shortcutReset: (path) => ipcRenderer.invoke(IPC.unigetuiShortcutReset, path),
    shortcutResetAll: () => ipcRenderer.invoke(IPC.unigetuiShortcutResetAll),
    logs: (kind, manager, level) => ipcRenderer.invoke(IPC.unigetuiLogs, kind, manager, level),
    backups: () => ipcRenderer.invoke(IPC.unigetuiBackups),
    backupLocalCreate: () => ipcRenderer.invoke(IPC.unigetuiBackupLocalCreate),
    backupCloudList: () => ipcRenderer.invoke(IPC.unigetuiBackupCloudList),
    backupCloudCreate: () => ipcRenderer.invoke(IPC.unigetuiBackupCloudCreate),
    backupCloudDownload: (key) => ipcRenderer.invoke(IPC.unigetuiBackupCloudDownload, key),
    backupCloudRestore: (key, append) => ipcRenderer.invoke(IPC.unigetuiBackupCloudRestore, key, append),
    backupLoginStart: (launchBrowser) => ipcRenderer.invoke(IPC.unigetuiBackupLoginStart, launchBrowser),
    backupLoginComplete: () => ipcRenderer.invoke(IPC.unigetuiBackupLoginComplete),
    backupLogout: () => ipcRenderer.invoke(IPC.unigetuiBackupLogout),
    bundle: () => ipcRenderer.invoke(IPC.unigetuiBundle),
    bundleReset: () => ipcRenderer.invoke(IPC.unigetuiBundleReset),
    bundleImport: (input) => ipcRenderer.invoke(IPC.unigetuiBundleImport, input),
    bundleExport: (path) => ipcRenderer.invoke(IPC.unigetuiBundleExport, path),
    bundleAdd: (input) => ipcRenderer.invoke(IPC.unigetuiBundleAdd, input),
    bundleRemove: (input) => ipcRenderer.invoke(IPC.unigetuiBundleRemove, input),
    bundleInstall: (input) => ipcRenderer.invoke(IPC.unigetuiBundleInstall, input),
    packageSearch: (query, manager, maxResults) => ipcRenderer.invoke(IPC.unigetuiPackageSearch, query, manager, maxResults),
    packageDetails: (id, manager, source) => ipcRenderer.invoke(IPC.unigetuiPackageDetails, id, manager, source),
    packageVersions: (id, manager, source) => ipcRenderer.invoke(IPC.unigetuiPackageVersions, id, manager, source),
    packageInstalled: (manager) => ipcRenderer.invoke(IPC.unigetuiPackageInstalled, manager),
    packageUpdates: (manager) => ipcRenderer.invoke(IPC.unigetuiPackageUpdates, manager),
    packageInstall: (id, options) => ipcRenderer.invoke(IPC.unigetuiPackageInstall, id, options),
