 ...
 * Server Edition and older callers without the optional profile service keep this shared fallback,
 * preventing direct node-pty and the host from drifting back to different platform defaults.
