...
export function searchEntries(
  ...
  return entries
    ...
    .map((e) => ({
      ...
      cwd: e.cwd,
      // The stored cwd may have come from another OS. Parse its explicit drive/UNC/POSIX syntax;
      // using this process's native basename makes Server Edition labels host-dependent.
      projectLabel: e.cwd ? basenameForPathSyntax(e.cwd) || e.cwd : '',
      mtime: e.mtime
    }))
}
