    ...
    <SettingsSection id="terminal" title="Terminal" isActive={isActive} searchEntries={ENTRIES}>
      ...
      <SearchableRow {...ROWS.theme}>
        <div className="space-y-3">
          <TerminalPreview />
          <FieldRow
            callsiteId="settings.terminal.theme"
            label="Colour theme"
      ...
      <SearchableRow {...ROWS.fontFamily}>
        <div className="space-y-3">
          ...
          <FieldRow
            callsiteId="settings.terminal.font"
            label="Font"
      ...
      <SearchableRow {...ROWS.fontSize}>
        <FieldRow
          callsiteId="settings.terminal.size-weight"
      ...
      <SearchableRow {...ROWS.spacing}>
        <FieldRow
          callsiteId="settings.terminal.spacing"
          label="Spacing"
      ...
      <SearchableRow {...ROWS.wordSeparators}>
        <FieldRow
          callsiteId="settings.terminal.word-separators"
      ...
      <SearchableRow {...ROWS.cursor}>
        <div className="space-y-3">
          ...
          <FieldRow
            callsiteId="settings.terminal.cursor"
            label="Cursor"
            control={
      ...
      <SearchableRow {...ROWS.cursorInactive}>
        <FieldRow
          callsiteId="settings.terminal.cursor-unfocused"
      ...
      <SearchableRow {...ROWS.middleClickPaste}>
        <div className="space-y-3">
          ...
          <FieldRow
            callsiteId="settings.terminal.middle-click"
      ...
      <SearchableRow {...ROWS.boldBright}>
        <div className="space-y-3">
          <FieldRow
            callsiteId="settings.terminal.bold-bright"
      ...
      <SearchableRow {...ROWS.minContrast}>
        <FieldRow
          callsiteId="settings.terminal.minimum-contrast"
      ...
      <SearchableRow {...ROWS.gpu}>
        <FieldRow
          callsiteId="settings.terminal.rendering"
