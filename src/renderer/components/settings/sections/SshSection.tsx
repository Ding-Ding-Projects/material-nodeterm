        ...
        <div className="space-y-4">
          ...
          {sshDraft ? (
            <div className="space-y-2 rounded-md border border-border p-3">
              ...
              />
              <FieldRow
                callsiteId="settings.ssh.remote-directory"
                label="Default working directory"
                description="Where browsing and Test connection start, and the default for new remote terminals and Codex nodes when no more specific folder is set."
                control={
                  <Input
              ...
              />
              <FieldRow
                callsiteId="settings.ssh.identity-file"
                label="Identity file"
              ...
              />
              <FieldRow
                callsiteId="settings.ssh.extra-args"
