...
export function AdhdModesSection({ isActive }: { isActive: boolean }): React.JSX.Element {
  ...
  return (
    ...
    >
      <SearchableRow {...mappedRows.focus} resolvedVocabulary={{ source: 'i18n', fields: 'all', searchEntries: 'mapped' }}>
        <FieldRow
      ...
      <SearchableRow {...mappedRows.lowStimulation} resolvedVocabulary={{ source: 'i18n', fields: 'all', searchEntries: 'mapped' }}>
        <FieldRow
      ...
      <SearchableRow {...mappedRows.timeAwareness} resolvedVocabulary={{ source: 'i18n', fields: 'all', searchEntries: 'mapped' }}>
        <FieldRow
      ...
      <SearchableRow {...mappedRows.oneThing} resolvedVocabulary={{ source: 'i18n', fields: 'all', searchEntries: 'mapped' }}>
        <FieldRow
      ...
      <SearchableRow {...mappedRows.momentum} resolvedVocabulary={{ source: 'i18n', fields: 'all', searchEntries: 'mapped' }}>
        <FieldRow
