...
export function LanguageSection({ isActive }: { isActive: boolean }): React.JSX.Element | null {
  ...
  return (
    ...
    >
      <SearchableRow {...mappedRows.mode} resolvedVocabulary={{ source: 'i18n', fields: 'all', searchEntries: 'mapped' }}>
        <FieldRow
      ...
      <SearchableRow {...mappedRows.funnyEn} resolvedVocabulary={{ source: 'i18n', fields: 'all', searchEntries: 'mapped' }}>
        <FieldRow
      ...
      <SearchableRow {...mappedRows.funnyYue} resolvedVocabulary={{ source: 'i18n', fields: 'all', searchEntries: 'mapped' }}>
        <FieldRow
      ...
      <SearchableRow {...mappedRows.emoji} resolvedVocabulary={{ source: 'i18n', fields: 'all', searchEntries: 'mapped' }}>
        <FieldRow
