  ...
  return (
    ...
    >
      <SearchableRow {...ROWS.engine}>
        <FieldRow
          callsiteId="settings.speech.engine"
          label="Engine"
      ...
      <SearchableRow {...ROWS.shortcut}>
        <FieldRow
          callsiteId="settings.speech.shortcut"
          label="Shortcut"
      ...
      <SearchableRow {...ROWS.models}>
        <div className="space-y-3">
          <h4 className="text-[13px] font-medium text-text"><SettingsText callsiteId="settings.speech.models-heading">Whisper models</SettingsText></h4>
          {models.length === 0 ? (
            <p className="text-[12px] text-muted"><SettingsText callsiteId="settings.speech.models-loading">Loading models…</SettingsText></p>
          ) : (
      ...
      <SearchableRow {...ROWS.language}>
        <FieldRow
          callsiteId="settings.speech.language"
          label="Language"
