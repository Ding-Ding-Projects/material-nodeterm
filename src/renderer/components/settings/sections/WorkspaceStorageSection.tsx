        ...
        <FieldRow
          ...
          note={
            ...
            settings.projectPartSizeUnit === DEFAULT_SETTINGS.projectPartSizeUnit
              ? `Using the built-in default (${DEFAULT_SETTINGS.projectPartSizeValue} ${DEFAULT_SETTINGS.projectPartSizeUnit}) — nobody has changed this yet.`
              : `Set to ${settings.projectPartSizeValue} ${settings.projectPartSizeUnit} (built-in default is ${DEFAULT_SETTINGS.projectPartSizeValue} ${DEFAULT_SETTINGS.projectPartSizeUnit}).`
          }
          control={
