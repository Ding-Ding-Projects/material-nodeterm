  ...
  return (
    <div className="homeassistant-sensor-panel" aria-label={copy('service.homeAssistantSensor', 'Home Assistant sensor display')}>
      ...
      <div className="homeassistant-sensor-panel__token">
        ...
        <Button variant="outlined" className="service-node__local-btn nodrag" disabled={!token} onClick={() => void saveToken()}>{copy('homeAssistant.saveToken', 'Save token')}</Button>
        <Button variant="outlined" className="service-node__local-btn nodrag" disabled={!tokenStored} onClick={() => void clearToken()}>{copy('homeAssistant.clearToken', 'Clear token')}</Button>
