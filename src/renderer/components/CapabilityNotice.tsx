 ...
 *    commit `agentBrowserControl: true`, and the user who cloned it was never asked. A warning at
 *    the point of SETTING (Settings → Agents) cannot reach them; this dialog can.
 *  - ONLY THE TWO BUTTONS ARE ANSWERS. "Keep it on" records 'kept'; "Turn it off" records
 *    'declined' and sheds the field. Escape, an overlay misclick, and a keystroke aimed at a
 *    terminal are NON-answers: `enterConfirms={false}` blocks the window-listener path,
 ...
 *    entry forever; 'declined' + a re-arriving `true` re-notices AND stays refused — a routine
