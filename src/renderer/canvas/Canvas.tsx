...
export function Canvas() {
  ...
  const buildCommands = useCallback((): Command[] => {
    ...
    const cmds: Command[] = [
      ...
      { id: 'open-cloudflare', label: 'Cloudflare manager', icon: <IconRemote />, run: () => setCloudflareOpen(true) },
  ...
  return (
    <div className="canvas-root">
      ...
      {(() => {
        ...
        const destinations: RailDestination[] = [
          ...
          },
          {
            ...
            icon: <IconConvert />,
            label: 'Tools',
            active: converterOpen || ollamaOpen || cloudflareOpen || pwmOpen,
            onClick: (anchor: HTMLElement) => {
              closeAllDrawers()
              leaveBoard()
              const r = anchor.getBoundingClientRect()
              setMenu({
                ...
                items: [
                  ...
                  { label: 'Cloudflare manager', onClick: () => setCloudflareOpen(true) },
                  {
      ...
      {cloudflareOpen && <CloudflareManagerPanel onClose={() => setCloudflareOpen(false)} />}
      {pwmOpen && (
        <PasswordManagerPanel
