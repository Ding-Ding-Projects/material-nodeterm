...
export function Canvas() {
  ...
  const [cloudFormationOpen, setCloudFormationOpen] = useState(false)
  ...
  const buildCommands = useCallback((): Command[] => {
    ...
    const cmds: Command[] = [
      ...
      { id: 'open-cloudformation', label: 'CloudFormation manager', icon: <IconConvert />, run: () => setCloudFormationOpen(true) },
  ...
  return (
    <div className="canvas-root">
      ...
      {(() => {
        ...
        const destinations: RailDestination[] = [
          ...
          },
          {
            ...
            icon: <IconConvert />,
            label: 'Tools',
            active: converterOpen || ollamaOpen || cloudFormationOpen || pwmOpen,
            onClick: (anchor: HTMLElement) => {
              closeAllDrawers()
              leaveBoard()
              const r = anchor.getBoundingClientRect()
              setMenu({
                ...
                items: [
                  ...
                  { label: 'CloudFormation manager', onClick: () => setCloudFormationOpen(true) },
                  {
      ...
      {cloudFormationOpen && <CloudFormationManagerPanel onClose={() => setCloudFormationOpen(false)} />}
      {pwmOpen && (
        <PasswordManagerPanel
