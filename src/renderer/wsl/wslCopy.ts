...
export const WSL_COPY = {
  ...
  bindCreated: { id: 'wsl.create.actions.bindCreated', fallback: 'Bind created instance' },
  bindingCreated: { id: 'wsl.create.actions.bindingCreated', fallback: 'Binding created instance…' },
  ...
  placementFailed: { id: 'wsl.create.error.placementFailed', fallback: 'WSL instance "{name}" was created, but its frame and first terminal could not be placed: {error}' },
