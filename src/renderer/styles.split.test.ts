...
const KNOWN_PARTIAL_OVERRIDES: KnownPartialOverride[] = [
  ...
  { selector: ".alarm-clock-node__body input:not(.mdx-input):not(.mdx-checkbox):not(.mdx-radio):not(.mdx-slider)", stillMissing: ["border", "border-radius", "padding", "background", "color"] },
  { selector: ".alarm-clock-node__body select:not(.mdx-select)", stillMissing: ["border", "border-radius", "padding", "background", "color"] },
  { selector: ".alarm-clock-node__actions button:not(.mdx-btn):not(.md3-icon-btn):not(.mdx-chip):not(.mdx-row):not(.md3-fab):not(.md3-switch)", stillMissing: ["border", "padding", "background", "color", "cursor"] },
  { selector: ".alarm-clock-node__history button:not(.mdx-btn):not(.md3-icon-btn):not(.mdx-chip):not(.mdx-row):not(.md3-fab):not(.md3-switch)", stillMissing: ["border", "padding", "background", "color", "cursor"] },
  { selector: ".alarm-clock-node__search button:not(.mdx-btn):not(.md3-icon-btn):not(.mdx-chip):not(.mdx-row):not(.md3-fab):not(.md3-switch)", stillMissing: ["padding"] },
  ...
  { selector: ".ctx-colors button:not(.mdx-btn):not(.md3-icon-btn):not(.mdx-chip):not(.mdx-row):not(.md3-fab):not(.md3-switch)", stillMissing: ["cursor", "height", "width"] },
  ...
  { selector: ".github-issue-move select:not(.mdx-select)", stillMissing: ["font-size", "height", "max-width"] },
  ...
  { selector: ".kanban-meta__picker > button:not(.mdx-btn):not(.md3-icon-btn):not(.mdx-chip):not(.mdx-row):not(.md3-fab):not(.md3-switch)", stillMissing: ["align-items", "background", "border", "cursor", "display", "font-size", "gap", "padding"] },
  ...
  { selector: ".native-loop-node__actions button:not(.mdx-btn):not(.md3-icon-btn):not(.mdx-chip):not(.mdx-row):not(.md3-fab):not(.md3-switch)", stillMissing: ["cursor", "flex", "height"] },
  ...
  { selector: ".native-loop-node__interval input:not(.mdx-input):not(.mdx-checkbox):not(.mdx-radio):not(.mdx-slider)", stillMissing: ["box-sizing", "height", "padding", "width"] },
  { selector: ".native-loop-node__interval select:not(.mdx-select)", stillMissing: ["box-sizing", "height"] },
  ...
  { selector: ".mdx-row.onb-model", stillMissing: ["position", "display", "align-items", "gap", "font-size", "padding", "cursor", "overflow"] },
  ...
  { selector: ".mdx-btn.onb-skip", stillMissing: ["position", "top", "right", "background", "border", "font-size", "cursor"] },
  ...
  { selector: ".react-flow__handle.bridge-handle", stillMissing: ["transition", "z-index"] },
  // Surfaces whose md3 rule currently re-declares only part of the base rule. Recorded from the
  // real base/md3 diff, exactly as the ones above were.
  { selector: ".windows-diagnostics-node", stillMissing: ["min-width", "min-height"] },
  { selector: ".windows-diagnostics-node__body", stillMissing: ["color"] },
  { selector: ".windows-diagnostics-node__tabs", stillMissing: ["overflow-x", "padding-bottom"] },
  { selector: ".windows-diagnostics-node__tabs button", stillMissing: ["min-height", "border", "border-radius", "background", "color", "padding", "cursor"] },
  { selector: ".windows-diagnostics-node__error", stillMissing: ["padding", "border-radius", "background"] },
  { selector: ".term-node__maximize", stillMissing: ["min-width", "gap"] },
  { selector: ".ss-ctx", stillMissing: ["font-size", "padding", "border-radius", "color", "font-weight", "flex"] },
  { selector: ".react-flow__handle.bridge-handle:hover", stillMissing: ["box-shadow"] },
  ...
  { selector: ".service-node :is(button:not(.mdx-btn):not(.md3-icon-btn):not(.mdx-chip):not(.mdx-row):not(.md3-fab):not(.md3-switch), input:not(.mdx-input):not(.mdx-checkbox):not(.mdx-radio):not(.mdx-slider)):focus-visible", stillMissing: ["outline", "outline-offset"] },
