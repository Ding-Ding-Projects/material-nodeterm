...
const KNOWN_PARTIAL_OVERRIDES: KnownPartialOverride[] = [
  ...
  { selector: ".kanban-card", stillMissing: ["cursor", "display", "padding", "position"] },
  { selector: ".kanban-card__detail", stillMissing: ["align-items", "border-top", "cursor", "display", "gap", "margin-top", "min-height", "padding-top"] },
  { selector: ".kanban-card__kind", stillMissing: ["font-size", "letter-spacing", "padding", "text-transform"] },
  { selector: ".kanban-card__kindlabel", stillMissing: ["flex", "font-size", "letter-spacing", "text-transform"] },
  { selector: ".kanban-card__profile", stillMissing: ["align-items", "display", "flex", "font-size", "gap", "line-height", "max-width", "padding", "white-space"] },
  { selector: ".kanban-card__profile--unavailable", stillMissing: ["border-color"] },
  { selector: ".kanban-card__profile--unknown", stillMissing: ["border-color", "border-style"] },
  { selector: ".kanban-card__profile-status", stillMissing: ["flex", "font-weight"] },
  { selector: ".kanban-card__session", stillMissing: ["flex", "font-size", "min-width", "overflow", "text-overflow", "white-space"] },
  { selector: ".kanban-card__stickytext", stillMissing: ["-webkit-box-orient", "-webkit-line-clamp", "display", "flex", "font-size", "min-width", "overflow", "white-space", "word-break"] },
  { selector: ".kanban-card__title", stillMissing: ["-webkit-box-orient", "-webkit-line-clamp", "display", "flex", "font-size", "font-weight", "line-height", "min-width", "overflow", "white-space", "word-break"] },
  { selector: ".kanban-card__unread", stillMissing: ["border-radius", "flex", "height", "width"] },
  { selector: ".kanban-card--drop-after::after", stillMissing: ["border-radius", "bottom", "content", "left", "position", "right", "z-index"] },
  { selector: ".kanban-card--drop-before::before", stillMissing: ["border-radius", "content", "left", "position", "right", "top", "z-index"] },
  { selector: ".kanban-col", stillMissing: ["display", "flex", "flex-basis", "flex-direction", "max-height", "max-width", "min-width", "width"] },
  { selector: ".kanban-col__close", stillMissing: ["background", "border", "cursor", "font-size", "padding"] },
  { selector: ".kanban-col__count", stillMissing: ["font-size"] },
  { selector: ".kanban-col__new", stillMissing: ["cursor", "font-size", "padding", "text-align", "transition", "width"] },
  { selector: ".kanban-col__newback", stillMissing: ["border-bottom", "border-radius", "margin-bottom"] },
  { selector: ".kanban-col__newchevron", stillMissing: ["font-size", "margin-left"] },
  { selector: ".kanban-col__newicon", stillMissing: ["display", "flex", "height", "width"] },
  { selector: ".kanban-col__newmenu", stillMissing: ["display", "flex-direction", "left", "margin-top", "padding", "position", "right", "top", "z-index"] },
  { selector: ".kanban-col__newmenu button", stillMissing: ["align-items", "background", "border", "cursor", "display", "font-size", "gap", "padding", "text-align"] },
  { selector: ".kanban-col__newmenu button[aria-disabled='true']", stillMissing: ["cursor"] },
  { selector: ".kanban-col__newreason", stillMissing: ["font-size", "line-height", "margin-top"] },
  { selector: ".kanban-col__rename", stillMissing: ["border", "flex", "font-size", "min-width", "outline", "padding"] },
  { selector: ".kanban-col__swatch", stillMissing: ["border", "border-radius", "cursor", "height", "padding", "width"] },
  { selector: ".kanban-col__title", stillMissing: ["cursor", "flex", "font-size", "font-weight", "overflow", "text-overflow", "white-space"] },
  { selector: ".kanban-col--drop", stillMissing: ["border-color"] },
  ...
  { selector: ".kanban-modal", stillMissing: ["animation", "display", "flex-direction", "height", "overflow", "width"] },
  { selector: ".kanban-modal__action", stillMissing: ["border", "cursor", "font-size", "padding"] },
  { selector: ".kanban-modal__column", stillMissing: ["font-size", "letter-spacing", "margin-right", "padding", "text-transform"] },
  { selector: ".kanban-modal__header", stillMissing: ["align-items", "border-bottom", "display", "flex", "gap", "padding"] },
  { selector: ".kanban-modal__placeholder", stillMissing: ["font-size", "margin"] },
  { selector: ".kanban-modal__profile", stillMissing: ["align-items", "display", "font-size", "gap", "max-width", "min-width", "padding", "white-space"] },
  { selector: ".kanban-modal__profile--unavailable", stillMissing: ["border-color"] },
  { selector: ".kanban-modal__profile--unknown", stillMissing: ["border-color", "border-style"] },
  { selector: ".kanban-modal__profile-status", stillMissing: ["flex", "font-size", "opacity"] },
  { selector: ".kanban-modal__rename", stillMissing: ["border", "flex", "font-size", "min-width", "outline", "padding"] },
  { selector: ".kanban-modal__sticky", stillMissing: ["background", "border", "flex", "font-family", "font-size", "line-height", "outline", "padding", "resize"] },
  { selector: ".kanban-modal__termwrap", stillMissing: ["display", "flex", "flex-direction", "min-height", "min-width", "padding", "position"] },
  { selector: ".kanban-modal__termwrap--drop::after", stillMissing: ["border", "border-radius", "content", "inset", "pointer-events", "position", "z-index"] },
  { selector: ".kanban-modal__title", stillMissing: ["cursor", "font-size", "font-weight", "overflow", "text-overflow", "white-space"] },
  { selector: ".kanban-modal__upload", stillMissing: ["background", "bottom", "color", "font-size", "left", "padding", "position", "transform", "z-index"] },
  { selector: ".kanban-modal-scrim", stillMissing: ["align-items", "animation", "display", "inset", "justify-content", "position", "z-index"] },
  ...
  { selector: ".node-account-chip", stillMissing: ["flex-shrink", "font-size", "margin-left", "max-width", "overflow", "padding", "text-overflow", "white-space"] },
  ...
  { selector: ".palette", stillMissing: ["display", "flex-direction", "max-height", "max-width", "overflow", "width"] },
  { selector: ".palette__control", stillMissing: ["align-items", "display"] },
  { selector: ".palette__cycle", stillMissing: ["cursor", "font-size", "font-weight", "padding"] },
  { selector: ".palette__empty", stillMissing: ["color", "font-size", "padding", "text-align"] },
  { selector: ".palette__error", stillMissing: ["color", "font-size", "line-height"] },
  { selector: ".palette__header-row", stillMissing: ["align-items", "display"] },
  { selector: ".palette__hint", stillMissing: ["margin-left"] },
  { selector: ".palette__icon", stillMissing: ["align-items", "display", "flex-shrink", "justify-content"] },
  { selector: ".palette__input", stillMissing: ["background", "border", "color", "flex", "min-width", "outline"] },
  { selector: ".palette__item", stillMissing: ["align-items", "background", "border", "color", "cursor", "display", "font-size", "text-align", "width"] },
  { selector: ".palette__list", stillMissing: ["overflow-y"] },
  { selector: ".palette__secondary", stillMissing: ["color", "flex-shrink", "margin-left"] },
  { selector: ".palette__section", stillMissing: ["font-size", "font-weight", "letter-spacing", "text-transform"] },
  { selector: ".palette__size-toggle", stillMissing: ["align-self", "color", "cursor", "flex", "font-size", "font-weight", "margin-right", "padding"] },
  { selector: ".palette__size-toggle:hover", stillMissing: ["color"] },
  { selector: ".palette__switch", stillMissing: ["border-radius", "cursor", "display", "position"] },
  { selector: ".palette__switch-thumb", stillMissing: ["border-radius", "position"] },
  { selector: ".palette__switch.on .palette__switch-thumb", stillMissing: ["transform"] },
  { selector: ".palette--full", stillMissing: ["height", "max-height", "width"] },
  { selector: ".palette-overlay", stillMissing: ["-webkit-app-region", "align-items", "display", "inset", "justify-content", "padding-top", "position", "z-index"] },
  ...
  { selector: ".react-flow__node:has(.term-node.attention)::after", stillMissing: ["animation", "border-radius", "content", "inset", "opacity", "pointer-events", "position", "will-change", "z-index"] },
  { selector: ".react-flow__node:has(.term-node.unread)::after", stillMissing: ["animation", "border-radius", "content", "inset", "opacity", "pointer-events", "position", "will-change", "z-index"] },
  ...
  { selector: ".term-node", stillMissing: ["container-type", "display", "flex-direction", "height", "overflow", "width"] },
  { selector: ".term-node__ai", stillMissing: ["background", "border", "cursor", "flex-shrink", "font-size", "line-height", "padding"] },
  { selector: ".term-node__approve-btn", stillMissing: ["border", "cursor", "font-size", "font-weight", "line-height", "padding", "white-space"] },
  { selector: ".term-node__body", stillMissing: ["flex", "min-height", "position"] },
  { selector: ".term-node__body.dropping::after", stillMissing: ["align-items", "content", "display", "font-size", "font-weight", "inset", "justify-content", "pointer-events", "position", "z-index"] },
  { selector: ".term-node__chat", stillMissing: ["align-items", "background", "border", "cursor", "display", "flex-shrink", "line-height", "padding"] },
  { selector: ".term-node__close", stillMissing: ["background", "border", "cursor", "font-size", "line-height", "padding"] },
  { selector: ".term-node__closed", stillMissing: ["align-items", "display", "flex-direction", "font-size", "gap", "inset", "justify-content", "padding", "position", "text-align", "z-index"] },
  { selector: ".term-node__collapse", stillMissing: ["background", "border", "cursor", "flex-shrink", "font-size", "line-height", "padding"] },
  { selector: ".term-node__comments", stillMissing: ["animation", "bottom", "display", "left", "margin-left", "overflow", "position", "top", "width", "z-index"] },
  { selector: ".term-node__find", stillMissing: ["display", "flex-direction", "gap", "padding"] },
  { selector: ".term-node__find-btn", stillMissing: ["background", "border", "cursor", "flex-shrink", "font-size", "line-height", "padding"] },
  { selector: ".term-node__find-count", stillMissing: ["flex-shrink", "font-size", "font-variant-numeric"] },
  { selector: ".term-node__find-error", stillMissing: ["font-size", "line-height"] },
  { selector: ".term-node__find-input", stillMissing: ["flex", "font-size", "min-width", "outline", "padding"] },
  { selector: ".term-node__find-tag", stillMissing: ["flex-shrink", "font-size", "letter-spacing", "padding", "text-transform"] },
  { selector: ".term-node__header", stillMissing: ["align-items", "cursor", "display", "user-select"] },
  { selector: ".term-node__mascot--pulse", stillMissing: ["animation", "filter", "opacity"] },
  { selector: ".term-node__mic", stillMissing: ["align-items", "background", "border", "cursor", "display", "flex-shrink", "line-height", "padding"] },
  { selector: ".term-node__move-worktree", stillMissing: ["background", "border", "cursor", "flex-shrink", "font-size", "line-height", "padding"] },
  { selector: ".term-node__offscreen", stillMissing: ["align-items", "display", "font-size", "inset", "justify-content", "padding", "position", "text-align", "z-index"] },
  { selector: ".term-node__queued-run:hover", stillMissing: ["opacity"] },
  { selector: ".term-node__refresh", stillMissing: ["align-items", "background", "border", "cursor", "display", "flex-shrink", "line-height", "padding"] },
  { selector: ".term-node__reopen", stillMissing: ["cursor", "font-size", "padding"] },
  { selector: ".term-node__search", stillMissing: ["align-items", "background", "border", "cursor", "display", "flex-shrink", "line-height", "padding"] },
  { selector: ".term-node__session", stillMissing: ["flex-shrink", "font-size", "margin-left", "max-width", "overflow", "padding", "text-overflow", "white-space"] },
  { selector: ".term-node__status", stillMissing: ["align-items", "display", "flex-shrink", "gap", "margin-left"] },
  { selector: ".term-node__status--attention .term-node__status-dot", stillMissing: ["animation"] },
  { selector: ".term-node__status--busy .term-node__status-dot", stillMissing: ["animation"] },
  { selector: ".term-node__status--queued", stillMissing: ["gap"] },
  { selector: ".term-node__status--sleeping", stillMissing: ["border", "cursor", "font", "font-size", "font-weight", "letter-spacing", "padding"] },
  { selector: ".term-node__status-dot", stillMissing: ["background", "border-radius"] },
  { selector: ".term-node__title", stillMissing: ["background", "border", "flex", "font-size", "font-weight", "min-width", "outline"] },
  { selector: ".term-node__title-text", stillMissing: ["border-radius", "cursor", "font-size", "font-weight", "max-width", "overflow", "padding", "text-overflow", "white-space"] },
  { selector: ".term-node__title:focus", stillMissing: ["padding"] },
  { selector: ".term-node__upload", stillMissing: ["align-items", "display", "font-size", "font-weight", "gap", "inset", "justify-content", "pointer-events", "position", "z-index"] },
  { selector: ".term-node__upload-spin", stillMissing: ["animation", "border", "border-radius", "height", "width"] },
  { selector: ".term-ssh-chip", stillMissing: ["flex-shrink", "font-size", "margin-left", "max-width", "overflow", "padding", "text-overflow", "white-space"] },
  ...
  { selector: ".tooltip", stillMissing: ["pointer-events", "position", "transform", "white-space", "z-index"] },
