...
/**
 * The Ctrl+1-9 "jump to the Nth project" chord, ONE decision shared by the three places
 ...
 *
 * 1. **Desktop only.** Chrome, Firefox and Safari all own Ctrl+1-9 for tab
 ...
 *
 * Accepts the Windows Ctrl modifier. Alt is
