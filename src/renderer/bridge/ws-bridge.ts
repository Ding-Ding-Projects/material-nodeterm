...
export function buildRealApi(
  ...
  NodeTerminalApi,
  'pty' | 'workspace' | 'serverDeployment' | 'settings' | 'schoolMode' | 'kidsMode' | 'scheduledSettings' | 'durableOccurrences' | 'userDataDir'
> {
  const pty: PtyApi = {
  ...
  return { pty, workspace, serverDeployment, settings, schoolMode, kidsMode, scheduledSettings, durableOccurrences, userDataDir }
}
