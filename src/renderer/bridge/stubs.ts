...
> {
  const api = {
    ...
    unigetui: {
      ...
      saveUniverseState: U('unigetui.saveUniverseState'),
      appStatus: U('unigetui.appStatus'),
      navigate: U('unigetui.navigate'),
      operations: U('unigetui.operations'),
      operation: U('unigetui.operation'),
      operationOutput: U('unigetui.operationOutput'),
      operationWait: U('unigetui.operationWait'),
      operationCancel: U('unigetui.operationCancel'),
      operationRetry: U('unigetui.operationRetry'),
      operationReorder: U('unigetui.operationReorder'),
      operationForget: U('unigetui.operationForget'),
      managers: U('unigetui.managers'),
      managerAction: U('unigetui.managerAction'),
      sources: U('unigetui.sources'),
      sourceAdd: U('unigetui.sourceAdd'),
      sourceRemove: U('unigetui.sourceRemove'),
      settings: U('unigetui.settings'),
      settingGet: U('unigetui.settingGet'),
      settingSet: U('unigetui.settingSet'),
      settingClear: U('unigetui.settingClear'),
      settingsReset: U('unigetui.settingsReset'),
      shortcuts: U('unigetui.shortcuts'),
      shortcutSet: U('unigetui.shortcutSet'),
      shortcutReset: U('unigetui.shortcutReset'),
      shortcutResetAll: U('unigetui.shortcutResetAll'),
      logs: U('unigetui.logs'),
      backups: U('unigetui.backups'),
      backupLocalCreate: U('unigetui.backupLocalCreate'),
      backupCloudList: U('unigetui.backupCloudList'),
      backupCloudCreate: U('unigetui.backupCloudCreate'),
      backupCloudDownload: U('unigetui.backupCloudDownload'),
      backupCloudRestore: U('unigetui.backupCloudRestore'),
      backupLoginStart: U('unigetui.backupLoginStart'),
      backupLoginComplete: U('unigetui.backupLoginComplete'),
      backupLogout: U('unigetui.backupLogout'),
      bundle: U('unigetui.bundle'),
      bundleReset: U('unigetui.bundleReset'),
      bundleImport: U('unigetui.bundleImport'),
      bundleExport: U('unigetui.bundleExport'),
      bundleAdd: U('unigetui.bundleAdd'),
      bundleRemove: U('unigetui.bundleRemove'),
      bundleInstall: U('unigetui.bundleInstall'),
      packageSearch: U('unigetui.packageSearch'),
      packageDetails: U('unigetui.packageDetails'),
      packageVersions: U('unigetui.packageVersions'),
      packageInstalled: U('unigetui.packageInstalled'),
      packageUpdates: U('unigetui.packageUpdates'),
      packageInstall: U('unigetui.packageInstall'),
    ...
    dockerHost: {
      listHosts: () => unsupported('dockerHost.listHosts'),
      saveHost: () => unsupported('dockerHost.saveHost'),
      removeHost: () => unsupported('dockerHost.removeHost'),
      verify: () => unsupported('dockerHost.verify'),
      listContexts: () => unsupported('dockerHost.listContexts'),
      inventory: () => unsupported('dockerHost.inventory'),
      listContainers: () => unsupported('dockerHost.listContainers'),
      listImages: () => unsupported('dockerHost.listImages'),
      listVolumes: () => unsupported('dockerHost.listVolumes'),
      listNetworks: () => unsupported('dockerHost.listNetworks'),
      listCompose: () => unsupported('dockerHost.listCompose'),
      startContainer: () => unsupported('dockerHost.startContainer'),
      stopContainer: () => unsupported('dockerHost.stopContainer'),
      restartContainer: () => unsupported('dockerHost.restartContainer'),
      pauseContainer: () => unsupported('dockerHost.pauseContainer'),
      unpauseContainer: () => unsupported('dockerHost.unpauseContainer'),
      stats: () => unsupported('dockerHost.stats'),
      logs: () => unsupported('dockerHost.logs'),
      exec: () => unsupported('dockerHost.exec'),
      previewDestructive: () => unsupported('dockerHost.previewDestructive'),
      removeContainers: () => unsupported('dockerHost.removeContainers'),
      removeImages: () => unsupported('dockerHost.removeImages'),
      removeVolumes: () => unsupported('dockerHost.removeVolumes'),
      removeNetworks: () => unsupported('dockerHost.removeNetworks'),
      composeUp: () => unsupported('dockerHost.composeUp'),
      composeDown: () => unsupported('dockerHost.composeDown')
    },
    torrent: {
