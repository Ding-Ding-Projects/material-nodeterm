...
> {
  const api = {
    ...
    cloudflare: {
      tokenStatus: () => unsupported('cloudflare.tokenStatus'),
      saveToken: () => unsupported('cloudflare.saveToken'),
      clearToken: () => unsupported('cloudflare.clearToken'),
      status: () => unsupported('cloudflare.status'),
      permissions: () => unsupported('cloudflare.permissions'),
      accounts: () => unsupported('cloudflare.accounts'),
      zones: () => unsupported('cloudflare.zones'),
      dnsRecords: () => unsupported('cloudflare.dnsRecords'),
      sslTlsSettings: () => unsupported('cloudflare.sslTlsSettings'),
      rulesets: () => unsupported('cloudflare.rulesets'),
      redirectRules: () => unsupported('cloudflare.redirectRules'),
      analytics: () => unsupported('cloudflare.analytics'),
      createDnsRecord: () => unsupported('cloudflare.createDnsRecord'),
      updateDnsRecord: () => unsupported('cloudflare.updateDnsRecord'),
      previewDeleteDnsRecord: () => unsupported('cloudflare.previewDeleteDnsRecord'),
      deleteDnsRecord: () => unsupported('cloudflare.deleteDnsRecord'),
      updateSslTlsSetting: () => unsupported('cloudflare.updateSslTlsSetting'),
      createRuleset: () => unsupported('cloudflare.createRuleset'),
      updateRuleset: () => unsupported('cloudflare.updateRuleset'),
      previewDeleteRuleset: () => unsupported('cloudflare.previewDeleteRuleset'),
      deleteRuleset: () => unsupported('cloudflare.deleteRuleset'),
      createRedirectRule: () => unsupported('cloudflare.createRedirectRule'),
      updateRedirectRule: () => unsupported('cloudflare.updateRedirectRule'),
      previewDeleteRedirectRule: () => unsupported('cloudflare.previewDeleteRedirectRule'),
      deleteRedirectRule: () => unsupported('cloudflare.deleteRedirectRule'),
      previewPurgeCache: () => unsupported('cloudflare.previewPurgeCache'),
      purgeCache: () => unsupported('cloudflare.purgeCache')
    }
  } satisfies Omit<
    NodeTerminalApi,
    | 'pty'
