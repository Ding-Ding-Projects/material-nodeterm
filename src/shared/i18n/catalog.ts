...
export const CATALOG: Catalog = {
  // Calendar node chrome. Event titles, source names, timezones, recurrence rules, and provider
  // facts are user data and stay literal; only application-authored labels route through this table.
  'calendar.title': { en: flat('Calendar'), yue: flat('日曆') },
  'calendar.searchEvents': { en: flat('Search events'), yue: flat('搜尋活動') },
  'calendar.searchSources': { en: flat('Filter calendar sources'), yue: flat('篩選日曆來源') },
  'calendar.searchTimezones': { en: flat('Filter timezones'), yue: flat('篩選時區') },
  'calendar.source': { en: flat('Source'), yue: flat('來源') },
  'calendar.timezone': { en: flat('Timezone'), yue: flat('時區') },
  'calendar.showWeekends': { en: flat('Show weekends'), yue: flat('顯示週末') },
  'calendar.previous': { en: flat('Previous period'), yue: flat('上一段時間') },
  'calendar.next': { en: flat('Next period'), yue: flat('下一段時間') },
  'calendar.today': { en: flat('Today'), yue: flat('今日') },
  'calendar.create': { en: flat('Create event'), yue: flat('建立活動') },
  'calendar.refresh': { en: flat('Refresh calendar'), yue: flat('重新整理日曆') },
  'calendar.export': { en: flat('Export visible or selected'), yue: flat('匯出顯示或已選項目') },
  'calendar.undo': { en: flat('Undo local change'), yue: flat('還原本機變更') },
  'calendar.noMatch': { en: flat('No events match this view.'), yue: flat('此檢視沒有符合的活動。') },
  'calendar.views': { en: flat('Calendar views'), yue: flat('日曆檢視') },
  'calendar.agenda': { en: flat('Agenda'), yue: flat('議程') },
  'calendar.week': { en: flat('Week'), yue: flat('星期') },
  'calendar.month': { en: flat('Month'), yue: flat('月份') },
  'calendar.selectAll': { en: flat('Select all visible'), yue: flat('選取所有顯示項目') },
  'calendar.invert': { en: flat('Invert selection'), yue: flat('反轉選取') },
  'calendar.deleteSelected': { en: flat('Delete selected'), yue: flat('刪除已選項目') },
  'calendar.copySelected': { en: flat('Copy selected'), yue: flat('複製已選項目') },
  'calendar.restoreHistory': { en: flat('Restore latest history'), yue: flat('還原最近歷史版本') },
  'calendar.account': { en: flat('Account'), yue: flat('帳戶') },
  'calendar.calendar': { en: flat('Calendar'), yue: flat('日曆') },
  'calendar.exportFormat': { en: flat('Export format'), yue: flat('匯出格式') },
  'calendar.searchAccounts': { en: flat('Filter accounts'), yue: flat('篩選帳戶') },
  'calendar.searchCalendars': { en: flat('Filter calendars'), yue: flat('篩選日曆') },
  'calendar.edit': { en: flat('Edit event'), yue: flat('編輯活動') },
  'calendar.createEvent': { en: flat('Create event'), yue: flat('建立活動') },
  'calendar.titleField': { en: flat('Title'), yue: flat('標題') },
  'calendar.starts': { en: flat('Starts'), yue: flat('開始') },
  'calendar.ends': { en: flat('Ends'), yue: flat('結束') },
  'calendar.location': { en: flat('Location'), yue: flat('地點') },
  'calendar.description': { en: flat('Description'), yue: flat('描述') },
  'calendar.allDay': { en: flat('All-day event'), yue: flat('全日活動') },
  'calendar.recurrence': { en: flat('Recurrence rule (optional)'), yue: flat('重複規則（可選）') },
  'calendar.sourceName': { en: flat('Source name'), yue: flat('來源名稱') },
  'calendar.cancel': { en: flat('Cancel'), yue: flat('取消') },
  'calendar.saveChanges': { en: flat('Save changes'), yue: flat('儲存變更') },
  // ---------------------------------------------------------------------------------------
