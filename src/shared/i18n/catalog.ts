...
export const CATALOG: Catalog = {
  ...
  'universeShop.title': { en: flat('Shop'), yue: flat('商店') },
  'universeShop.scope': { en: flat('{scope} catalog'), yue: flat('{scope} 目錄') },
  'universeShop.scope.aws': { en: flat('AWS Universe'), yue: flat('AWS 宇宙') },
  'universeShop.scope.multiverse': { en: flat('Multiverse'), yue: flat('多元宇宙') },
  'universeShop.scope.unknown': { en: flat('Unknown universe'), yue: flat('未知宇宙') },
  'universeShop.description': { en: flat('Choose a node to create in this universe. The catalog is scoped and stays local to this Shop.'), yue: flat('揀一個節點喺呢個宇宙建立。目錄有範圍，留喺呢間商店入面。') },
  'universeShop.search.label': { en: flat('Search catalog'), yue: flat('搜尋目錄') },
  'universeShop.search.placeholder': { en: flat('Search nodes'), yue: flat('搜尋節點') },
  'universeShop.search.regex': { en: flat('Open regex builder for this catalog'), yue: flat('開啟呢個目錄嘅正則建立器') },
  'universeShop.search.error': { en: flat('Pattern is invalid. Showing all scoped entries.'), yue: flat('模式無效，依家顯示全部範圍內項目。') },
  'universeShop.search.count': { en: flat('{count} scoped entries'), yue: flat('{count} 個範圍內項目') },
  'universeShop.empty': { en: flat('No catalog entries match this search.'), yue: flat('冇目錄項目符合呢個搜尋。') },
  'universeShop.catalogUnavailable': { en: flat('The unified Node Catalog is unavailable in this build. Enable the catalog dependency before creating nodes.'), yue: flat('呢個版本未有共用節點目錄。請先啟用目錄功能，之後先可以建立節點。') },
  'universeShop.invalidScope': { en: flat('This Shop has incomplete universe scope metadata, so catalog creation is unavailable.'), yue: flat('呢間商店嘅宇宙範圍資料唔完整，所以暫時未可以建立目錄項目。') },
  'universeShop.entryUnavailable': { en: flat('This catalog entry is unavailable until its executor is available.'), yue: flat('呢個目錄項目要等執行功能可用先可以使用。') },
  'universeShop.entries.aria': { en: flat('Available catalog entries'), yue: flat('可用目錄項目') },
  'universeShop.selected': { en: flat('{entry} selected. Use the shared creation action to continue.'), yue: flat('已揀 {entry}，用共用建立動作繼續。') },
  'universeShop.hint': { en: flat('This Shop stays available as the one catalog entry point for this universe.'), yue: flat('呢間商店會一直做呢個宇宙唯一嘅目錄入口。') },
  'universeShop.aria.label': { en: flat('Shop for {scope}'), yue: flat('{scope} 商店') },
  'universeShop.fixed.title': { en: flat('This Shop belongs to its universe and cannot be moved or deleted.'), yue: flat('呢間商店屬於自己嘅宇宙，唔可以移動或者刪除。') },
  'universeCanvas.aria': { en: flat('{title} canvas'), yue: flat('{title} 畫布') },
  'universeCanvas.return.aria': { en: flat('Return to root canvas'), yue: flat('返回根畫布') },
  'universeCanvas.root': { en: flat('Root canvas'), yue: flat('根畫布') },
  'universeCanvas.depth': { en: flat('depth {depth}'), yue: flat('深度 {depth}') },
  'universeCanvas.shopDescription': { en: flat("Use this universe's scoped Node Catalog to create nodes here."), yue: flat('用呢個宇宙嘅範圍節點目錄喺呢度建立節點。') },
  'universeCanvas.members': { en: flat('{count} members'), yue: flat('{count} 個成員') },
  'universeCanvas.missingShop': { en: flat('This child canvas has no Shop yet. Repair the canvas projection before creating nodes.'), yue: flat('呢個子畫布仲未有商店，建立節點前請先修復畫布投影。') },
  'universeCanvas.openCatalog': { en: flat('Open scoped catalog'), yue: flat('開啟指定範圍目錄') }
}
