...
export const IPC = {
  ...
  // AWS CLI v2 manager (docs/aws-cli-manager.md). The privileged shell owns the
  // verified installer, executable selection, model inventory, and cancellation.
  awsStatus: 'aws:status',
  awsEnsure: 'aws:ensure',
  awsRepair: 'aws:repair',
  awsCancel: 'aws:cancel',
  awsModels: 'aws:models',
  awsRefreshModels: 'aws:refresh-models',
  awsStatusChanged: 'aws:status-changed',
