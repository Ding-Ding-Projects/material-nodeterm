...
export const IPC = {
  ...
  cloudflareTunnelCredentialSave: 'cloudflare-tunnels:credential-save',
  cloudflareTunnelCredentialClear: 'cloudflare-tunnels:credential-clear',
  cloudflareTunnelCredentialStatus: 'cloudflare-tunnels:credential-status',
