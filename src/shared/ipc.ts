...
export const IPC = {
  ...
  gitDependencyOperation: 'git:dependency-operation',
  gitDependencyCancel: 'git:dependency-cancel',
  gitDependencyProgress: 'git:dependency-progress',
  ...
  unigetuiStatus: 'unigetui:status',
  unigetuiUniverseState: 'unigetui:universe-state',
  unigetuiSaveUniverseState: 'unigetui:save-universe-state',
  unigetuiAppStatus: 'unigetui:app-status',
  unigetuiNavigate: 'unigetui:navigate',
  unigetuiOperations: 'unigetui:operations',
  unigetuiOperation: 'unigetui:operation',
  unigetuiOperationOutput: 'unigetui:operation-output',
  unigetuiOperationWait: 'unigetui:operation-wait',
  unigetuiOperationCancel: 'unigetui:operation-cancel',
  unigetuiOperationRetry: 'unigetui:operation-retry',
  unigetuiOperationReorder: 'unigetui:operation-reorder',
  unigetuiOperationForget: 'unigetui:operation-forget',
  unigetuiManagers: 'unigetui:managers',
  unigetuiManagerAction: 'unigetui:manager-action',
  unigetuiSources: 'unigetui:sources',
  unigetuiSourceAdd: 'unigetui:source-add',
  unigetuiSourceRemove: 'unigetui:source-remove',
  unigetuiSettings: 'unigetui:settings',
  unigetuiSettingGet: 'unigetui:setting-get',
  unigetuiSettingSet: 'unigetui:setting-set',
  unigetuiSettingClear: 'unigetui:setting-clear',
  unigetuiSettingsReset: 'unigetui:settings-reset',
  unigetuiShortcuts: 'unigetui:shortcuts',
  unigetuiShortcutSet: 'unigetui:shortcut-set',
  unigetuiShortcutReset: 'unigetui:shortcut-reset',
  unigetuiShortcutResetAll: 'unigetui:shortcut-reset-all',
  unigetuiLogs: 'unigetui:logs',
  unigetuiBackups: 'unigetui:backups',
  unigetuiBackupLocalCreate: 'unigetui:backup-local-create',
  unigetuiBackupCloudList: 'unigetui:backup-cloud-list',
  unigetuiBackupCloudCreate: 'unigetui:backup-cloud-create',
  unigetuiBackupCloudDownload: 'unigetui:backup-cloud-download',
  unigetuiBackupCloudRestore: 'unigetui:backup-cloud-restore',
  unigetuiBackupLoginStart: 'unigetui:backup-login-start',
  unigetuiBackupLoginComplete: 'unigetui:backup-login-complete',
  unigetuiBackupLogout: 'unigetui:backup-logout',
  unigetuiBundle: 'unigetui:bundle',
  unigetuiBundleReset: 'unigetui:bundle-reset',
  unigetuiBundleImport: 'unigetui:bundle-import',
  unigetuiBundleExport: 'unigetui:bundle-export',
  unigetuiBundleAdd: 'unigetui:bundle-add',
  unigetuiBundleRemove: 'unigetui:bundle-remove',
  unigetuiBundleInstall: 'unigetui:bundle-install',
  unigetuiPackageSearch: 'unigetui:package-search',
  unigetuiPackageDetails: 'unigetui:package-details',
  unigetuiPackageVersions: 'unigetui:package-versions',
  unigetuiPackageInstalled: 'unigetui:package-installed',
  unigetuiPackageUpdates: 'unigetui:package-updates',
  unigetuiPackageInstall: 'unigetui:package-install',
  unigetuiPackageDownload: 'unigetui:package-download',
  ...
  // Recovered verbatim from the commits that introduced each family. The merge kept every
  // one of these consumers and dropped their keys from the map; a guessed channel string
  // does not fail loudly, it silently unbinds the handler.
