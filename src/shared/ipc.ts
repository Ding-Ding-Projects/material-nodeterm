...
export const IPC = {
  ...
  cloudFormationListStacks: 'cloudformation:list-stacks',
  cloudFormationInspectTemplate: 'cloudformation:inspect-template',
  cloudFormationPreview: 'cloudformation:preview',
  cloudFormationCancelPreview: 'cloudformation:cancel-preview',
