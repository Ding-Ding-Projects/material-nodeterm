...
export type ShortcutAction =
  ...
  | 'toggleViewMode' // ⌘⇧B
  | 'toggleSessionsPin' // ⌘⇧L
  | 'toggleFocusMode' // ⌘⇧F — one node fills the window, chrome yields
  | 'findInTerminal' // ⌘F
...
export const SHORTCUT_DEFS: ShortcutDef[] = [
  ...
  { id: 'toggleFocusMode', group: 'Canvas', label: 'Toggle focus mode', default: 'Cmd+Shift+F', keywords: ['focus', 'mode', 'fullscreen', 'zen', 'zoom'] },
