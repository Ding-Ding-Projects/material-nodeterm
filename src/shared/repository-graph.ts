...
export const REPOSITORY_GRAPH_ADAPTERS: readonly RepositoryGraphAdapterInfo[] = [
  ...
  { id: 'yarn-lockfile', version: '1', kind: 'lockfile', patterns: ['yarn.lock'], available: true },
  { id: 'pnpm-lockfile', version: '1', kind: 'lockfile', patterns: ['pnpm-lock.yaml'], available: true },
  { id: 'bun-lockfile', version: '1', kind: 'lockfile', patterns: ['bun.lock', 'bun.lockb'], available: true },
  { id: 'python-manifest', version: '1', kind: 'manifest', patterns: ['pyproject.toml', 'requirements*.txt', 'Pipfile', 'poetry.lock', 'uv.lock'], available: true },
  { id: 'cargo-manifest', version: '1', kind: 'manifest', patterns: ['Cargo.toml', 'Cargo.lock'], available: true },
  { id: 'go-manifest', version: '1', kind: 'manifest', patterns: ['go.mod', 'go.work', 'go.sum'], available: true },
  { id: 'maven-gradle-manifest', version: '1', kind: 'manifest', patterns: ['pom.xml', 'build.gradle', 'build.gradle.kts'], available: true },
  { id: 'dotnet-manifest', version: '1', kind: 'manifest', patterns: ['*.sln', '*.csproj', 'packages.lock.json', 'Directory.Packages.props'], available: true },
  { id: 'ruby-manifest', version: '1', kind: 'manifest', patterns: ['Gemfile', 'Gemfile.lock'], available: true },
  { id: 'composer-manifest', version: '1', kind: 'manifest', patterns: ['composer.json', 'composer.lock'], available: true },
  { id: 'dart-manifest', version: '1', kind: 'manifest', patterns: ['pubspec.yaml', 'pubspec.lock'], available: true },
  { id: 'swift-manifest', version: '1', kind: 'manifest', patterns: ['Package.swift', 'Package.resolved'], available: true },
  { id: 'cmake-manifest', version: '1', kind: 'manifest', patterns: ['CMakeLists.txt', 'vcpkg.json', 'conanfile.*'], available: true },
  { id: 'container-manifest', version: '1', kind: 'manifest', patterns: ['Dockerfile', 'docker-compose.yml', 'compose.yml'], available: true },
  { id: 'gitmodules-manifest', version: '1', kind: 'manifest', patterns: ['.gitmodules'], available: true }
]
