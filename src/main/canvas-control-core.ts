...
export function buildCanvasControlInstructions(shimPath: string): string {
  return [
    ...
    '- `open-terminal [--count N] [--cwd P] [--cmd C] [--group <id>] [--after <id,id>] [--project <id|cwd>]` — open N plain terminals.',
    '- `open-claude [--count N] [--cwd P] [--prompt T] [--group <id>] [--after <id,id>] [--project <id|cwd>]` — open N Claude sessions.',
    '- `open-agent --agent claude|codex|gemini|opencode|copilot|<custom-id> [--resume <session-id>] [--account system|<id>] [--count N] [--cwd P] [--prompt T] [--group <id>] [--after <id,id>] [--project <id|cwd>]` — open',
...
- \`open-terminal [--count N] [--cwd P] [--cmd C] [--group <id>] [--after <id,id>] [--project <id|cwd>]\` — open N plain terminals (default 1).
- \`open-claude [--count N] [--cwd P] [--prompt T] [--group <id>] [--after <id,id>] [--project <id|cwd>]\` — open N Claude sessions (default 1).
- \`open-agent --agent claude|codex|gemini|opencode|copilot|<custom-id> [--resume <session-id>] [--account system|<id>] [--count N] [--cwd P] [--prompt T] [--group <id>] [--after <id,id>] [--project <id|cwd>]\` — open N sessions of any agent CLI.
