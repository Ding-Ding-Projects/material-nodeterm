...
import { registerHomeAssistantIpc, type HomeAssistantManager } from '../../core/home-assistant'
...
): { gitService: GitService; minecraftServers: MinecraftServerManager; homeAssistantManager: HomeAssistantManager } {
